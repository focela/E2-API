...
//
// Fetching Rules:
// 1. Command line arguments are in lowercase format, eg: gc.package.variable;
// 2. Environment arguments are in uppercase format, eg: GC_PACKAGE_VARIABLE；
